...
const AWS_RDS_USER = process.env.AWS_RDS_USER;
const AWS_RDS_PW = process.env.AWS_RDS_PW;
const AWS_RDS_HOST_1 = process.env.AWS_RDS_HOST_1;
...
class MySQLConnector 
{
    ...
    constructor(host=null,user=null,password=null,db=null)
    {
        ...
        this.host       = host? host :          AWS_RDS_HOST_1
        this.user       = user? user :          AWS_RDS_USER
        this.password   = password? password :  AWS_RDS_PW
        this.db         = db? db :              "discord_main";
        this.con        = null;
